source_file="../processed_result/runtime_medium_density_6query_points.txt"
eps_file="../runtime_medium_density_6query_points.eps"
...
set xlabel offset 0,1.2 \"K\" font \"Helvetica-Bold, 26\"
