...
public class Region implements IShape, Cloneable
{
  ...
  {
    if ( (this.getLow(core.Point.TIME_DIM) - b.getHigh(core.Point.TIME_DIM)) > time )
      return false;
    if ( (b.getLow(core.Point.TIME_DIM) - this.getHigh(core.Point.TIME_DIM)) > time )
      return false;
