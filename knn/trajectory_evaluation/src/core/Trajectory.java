...
import distanceRankers.EDROperator;
import distanceRankers.ERPOperator;
import distanceRankers.EuclideanOperator;
...
public class Trajectory implements Cloneable {
	...
	*/
	...
	protected void createTrajectory(int id, 
		...
		int i = 0;
		Point p = null;
		for (Iterator<Point> itor = data.iterator(); itor.hasNext(); ) {
			p = itor.next();
	...
	*/
	...
	public static void main(String[] args) {
		...
		a1.add(new Point(new double[]{1,9,0}));
		a1.add(new Point(new double[]{2,2,2}));
		a1.add(new Point(new double[]{3,4,3}));
		a1.add(new Point(new double[]{4,5,3.5}));

		ArrayList<Point> a2 = new ArrayList<Point>();
		a2.add(new Point(new double[]{1,3,0}));
		a2.add(new Point(new double[]{1,5,2}));
		a2.add(new Point(new double[]{3,4,3}));
		a2.add(new Point(new double[]{1,7,3.5}));
		a2.add(new Point(new double[]{2,3,4}));

		try {
			Trajectory tr1 = new Trajectory("1", a1, new ERPOperator());
		    Trajectory tr2 = new Trajectory("2", a2, new ERPOperator());
